            ...
            <div className='md:flex justify-between items-center px-5 my-5 '>
                <div className='border border-slate-300 rounded-xl  md:w-[48%] p-1'>
                    ...
                    <div className='lg:flex justify-between'>
                        <div style={{ backgroundImage: "url(src/images/homeLeft.jpeg)", backgroundSize: "cover", backgroundPosition: "center" }} className='h-[200px] px-3 lg:w-[48%] my-2 flex justify-center items-start rounded-xl flex-col text-slate-700'>
