    ...
    return (
        <>
            <div className='md:flex md:justify-between px-5 mt-4'>
                <div style={{ backgroundImage: `url(${sliderIMage})`, backgroundSize: 'contain', backgroundPosition: 'right', backgroundRepeat:"no-repeat" }} className="pl-6 md:w-[48%] md:mt-0 mt-6 bg-cover cursor-pointer md:h-[85vh] h-[60vh] rounded-xl shadow-xl shadow-slate-400 border-2 border-slate-300 flex md:justify-start justify-center  items-start flex-col">
                ...
                <div style={{ backgroundImage: `url(${homeLeft})`, backgroundSize: 'cover', backgroundPosition: 'center' }} className="pl-6 md:w-[48%]  md:mt-0 mt-6 md:h-[85vh] h-[60vh] rounded-xl shadow-xl cursor-pointer shadow-slate-400 border border-slate-400 flex  md:justify-start justify-center items-start flex-col">
                    <p className='text-slate-600 font-semibold lg:mt-[60px] md:mt-[30px] xl:text-xl lg:text-md'>Style like never before</p>
