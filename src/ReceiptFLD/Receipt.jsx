...
const Receipt = ({ product }) => {
  ...
  const { name, price, size, quantity, paymentMethod } = product;

  return (
    <div className="max-w-sm mx-auto my-4 bg-white shadow-md rounded-lg p-6 font-mono border-2 border-gray-300">
      ...
      <div className="space-y-2 mb-6">
        <p><span className='uppercase font-extrabold italic text-xl'>{name}</span> <span className="float-right underline ">${price}</span></p>
